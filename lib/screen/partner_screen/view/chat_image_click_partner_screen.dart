...
class ChatImageClickPartnerScreen extends StatefulWidget {
  const ChatImageClickPartnerScreen(this.url, {super.key});
  final String url;

  @override
  State<ChatImageClickPartnerScreen> createState() =>
      _ChatImageClickScreenPartnerState();
}

class _ChatImageClickScreenPartnerState
    extends State<ChatImageClickPartnerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return PageView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Obx(() => controller.isFill == true
            ? WillPopScope(
                onWillPop: () async {
                  return true;
                },
