...
import 'package:new_ap/screen/Home_screen/View/pages/rate_and_comment.dart';
            ...
            actions: [
              GetX<ProfileController>(
                builder: (controller) => IconButton(
                  ...
                  onPressed: () {
                    controller.favoriteMethod(kitchen.id, context);
                  },
                  icon: Icon(
                    controller.getIcon(kitchen.id)['icon'],
                    color: controller.getIcon(kitchen.id)['color'],
                  ),
                ...
                Container(
                  ...
                  child: Card(
                    ...
                    child: Column(children: <Widget>[
                      GestureDetector(
                        onTap: () {
                          Get.to(() => RateAndComment(kitchen.id.trim()));
                        },
                        child: Padding(
                          padding: const EdgeInsets.symmetric(
