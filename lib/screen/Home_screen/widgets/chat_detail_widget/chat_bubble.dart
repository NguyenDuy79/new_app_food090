          ...
          children: <Widget>[
            ...
            Container(
              constraints: const BoxConstraints(
                  minWidth: AppDimens.dimens_0, maxWidth: AppDimens.dimens_250),
              ...
              margin: const EdgeInsets.symmetric(
                  vertical: AppDimens.dimens_2, horizontal: AppDimens.dimens_8),
              child: Text(
                widget.content,
                style: TextStyle(
      ...
      return Padding(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Container(
                width: widget.content == 'like' ? width * 0.1 : width * 0.25,
                height: widget.content == 'like' ? width * 0.1 : width * 0.25,
                decoration: BoxDecoration(
                ...
                child: ClipRRect(
                    ...
                    child: widget.content == 'like'
                        ...
                        : Image.asset(
                            AppStoragePath.sticker[widget.content] as String)),
              )
            ],
          ));
                        ...
                        child: GridView.builder(
                            ...
                            gridDelegate:
                                SliverGridDelegateWithFixedCrossAxisCount(
                                    crossAxisCount: controller.getCrossCount(
                                        widget.content.split('"').length),
          ...
          : Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                      constraints: BoxConstraints(
                          maxWidth: width * 0.75, maxHeight: height * 0.5),
                      decoration: BoxDecoration(
                          color: ColorConstants.colorWhite,
                          borderRadius: BorderRadius.only(
                              topLeft: controller.getRadiusTopLeft(
                          ...
                          (controller.currenId.value == widget.index)
                              ? controller.formatTime(Duration(
                                  microseconds:
                                      controller.currentDuration.value))
                              : '00:00',
                          style: const TextStyle(fontSize: AppDimens.dimens_17),
                        ),
                      ),
                      Obx(
                        () => Expanded(
                          child: Padding(
                              padding: const EdgeInsets.symmetric(
                                  horizontal: AppDimens.dimens_10),
                              child: (controller.currenId.value == widget.index)
                                  ? Slider(
                                      activeColor: ColorConstants.colorGrey0,
                                      inactiveColor: ColorConstants.colorGrey4,
                                      min: 0,
