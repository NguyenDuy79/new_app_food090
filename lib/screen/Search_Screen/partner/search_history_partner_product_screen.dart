...
import 'package:new_ap/screen/partner_screen/view/pages/order_history_result_screen.dart';

import '../../../config/app_colors.dart';
import '../../../config/app_dimens.dart';

class HisotryOrderPartnerSearchScreen extends StatelessWidget {
  HisotryOrderPartnerSearchScreen({super.key});
                        ...
                        if (controller.textEditing.text.trim() != '') {
                          if (controller.isMain) {
                            if (controller.isCheck) {
                              ...
                              Get.off(() => OrderHistoryResultScreen());
                            }
                          } else {
                            if (controller.isCheck) {
                              controller.submitQuerySearch(
